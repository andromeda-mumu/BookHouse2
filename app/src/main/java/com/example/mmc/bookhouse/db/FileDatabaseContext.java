...
public class FileDatabaseContext extends ContextWrapper {
    ...
    public boolean createInitDatabase(File toFile, String name, Context context) {
        ...
        try {
            is = context.getClass().getClassLoader().getResourceAsStream("assets/" + "city.db");
//            is = context.getResources().openRawResource(context.getResources().getIdentifier("city", "raw", context.getPackageName()));
            // 创建输出流
